...
def main():
    for spp in [True]:
        for mod in ['resnet50', 'vgg16', 'alexnet']: # 
            ...
            for epoch in range(1, PARAMS['epochs'] + 1):
                ...
                scheduler.step()
            torch.save(model, 'new_saved_models/{}_{}_{}_proposed_nodiff_{}{}.pth'.format(date.today(),PARAMS['model_name'],round(current_acc,2),dataset,suffix))
